 ...
 * `apply_filters('mhm_rentiva_dashboard_vendor_application_pending', false, $user_id)`
...
class DashboardContextVendorStatesTest extends \WP_UnitTestCase
{
    protected function tearDown(): void
    {
        ...
        remove_all_filters('mhm_rentiva_dashboard_vendor_application_pending');
        parent::tearDown();
    }
    ...
    {
        remove_all_filters('mhm_rentiva_dashboard_vendor_application_pending');
        add_filter('mhm_rentiva_dashboard_vendor_application_pending', '__return_true');
