...
class SchemaParityTest extends WP_UnitTestCase
{
    ...
    /**
     * Verify that all shortcode default attributes exist in Registry.
     */
    ...
    /**
     * Verify that all block.json attributes exist in Registry.
     */
    public function test_block_json_attributes_are_in_registry()
    {
        ...
        $this->assertEquals(21, $blocks_found, 'Expected 21 block.json files to be found.');
    }
