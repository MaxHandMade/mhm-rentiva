...
/**
 * M-02: money conversion used a hard-coded 100 in 16 places.
 *
 ...
 * multiplier.
 */
final class PaymentStateScaleTest extends WP_UnitTestCase
{
    ...
    public function test_to_minor_honours_a_three_decimal_store(): void
    {
        ...
        $this->assertSame(19990, PaymentState::toMinor('19.990'));
    }
    ...
    public function test_to_minor_honours_a_zero_decimal_store(): void
    {
        ...
        $this->assertSame(1999, PaymentState::toMinor('1999'));
    }
    ...
    public function test_to_major_round_trips_through_to_minor(): void
    {
        ...
        $this->assertSame('1999.99', PaymentState::toMajor(PaymentState::toMinor('1999.99')));
    }
    ...
    public function test_decimals_defaults_to_two(): void
    {
        ...
        $this->assertSame(2, PaymentState::decimals());
    }

    // NOT TESTED HERE, ON PURPOSE: the WooCommerce-absent branch of decimals().
    // WooCommerce is always loaded in this suite -- WooCommerceTestEnvironmentTest
    // fails the whole run otherwise -- so a test claiming to measure its absence
    // would be measuring the option default and saying it measured something
    // else. The function_exists() guard is a source-level protection against a
    // fatal on a WC-less install, verified by reading it, not by this suite.
}
