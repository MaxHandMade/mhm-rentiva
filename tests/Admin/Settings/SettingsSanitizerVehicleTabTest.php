...
class SettingsSanitizerVehicleTabTest extends WP_UnitTestCase
{
    ...
    {
        $result = $this->sanitize_vehicle(['mhmrentiva_vehicle_url_base' => 'My Vehicles!']);
        $this->assertSame('my-vehicles', $result['mhmrentiva_vehicle_url_base']);
    }

    public function test_url_base_empty_falls_back_to_vehicle()
    {
        $result = $this->sanitize_vehicle(['mhmrentiva_vehicle_url_base' => '']);
        $this->assertSame('vehicle', $result['mhmrentiva_vehicle_url_base']);
    }
    ...
    public function test_sort_accepts_valid_enum_value()
    {
        $result = SettingsSanitizer::sanitize([
            ...
            'mhmrentiva_vehicle_default_sort' => 'name_desc',
        ]);
        $this->assertSame('name_desc', $result['mhmrentiva_vehicle_default_sort']);
    }
    ...
    public function test_sort_invalid_value_falls_back_to_price_asc()
    {
        $result = SettingsSanitizer::sanitize([
            'current_active_tab'               => 'frontend',
            'mhmrentiva_vehicle_default_sort' => 'totally_invalid',
        ]);
        $this->assertSame('price_asc', $result['mhmrentiva_vehicle_default_sort']);
    }
    ...
    {
        $result = $this->sanitize_vehicle(['mhmrentiva_vehicle_min_rental_days' => '3']);
        $this->assertSame(3, $result['mhmrentiva_vehicle_min_rental_days']);
    }

    public function test_min_rental_days_clamps_below_min()
    {
        $result = $this->sanitize_vehicle(['mhmrentiva_vehicle_min_rental_days' => '0']);
        $this->assertSame(1, $result['mhmrentiva_vehicle_min_rental_days']);
    }

    public function test_min_rental_days_clamps_above_max()
    {
        $result = $this->sanitize_vehicle(['mhmrentiva_vehicle_min_rental_days' => '999']);
        $this->assertSame(365, $result['mhmrentiva_vehicle_min_rental_days']);
    }
    ...
    {
        $result = $this->sanitize_vehicle(['mhmrentiva_vehicle_tax_rate' => '18']);
        $this->assertEqualsWithDelta(18.0, $result['mhmrentiva_vehicle_tax_rate'], 0.001);
    }

    public function test_tax_rate_clamps_negative_to_zero()
    {
        $result = $this->sanitize_vehicle(['mhmrentiva_vehicle_tax_rate' => '-5']);
        $this->assertEqualsWithDelta(0.0, $result['mhmrentiva_vehicle_tax_rate'], 0.001);
    }

    public function test_tax_rate_clamps_above_100()
    {
        $result = $this->sanitize_vehicle(['mhmrentiva_vehicle_tax_rate' => '150']);
        $this->assertEqualsWithDelta(100.0, $result['mhmrentiva_vehicle_tax_rate'], 0.001);
    }
    ...
    {
        $result = $this->sanitize_vehicle(['mhmrentiva_vehicle_base_price' => '-10']);
        $this->assertGreaterThanOrEqual(0.1, $result['mhmrentiva_vehicle_base_price']);
    }
}
