 ...
 * apply_filters('mhmrentiva_settings_tabs', array())) instead of
...
final class SettingsSanitizerProTabGateTest extends WP_UnitTestCase
{
    ...
    public function test_unlicensed_transfer_save_does_not_persist(): void
    {
        ...
        $this->assertSame(33, $result['mhmrentiva_transfer_deposit_rate'], 'Unlicensed transfer save must be a no-op.');
    }

    public function test_unlicensed_vendor_marketplace_save_does_not_persist(): void
    {
        update_option('mhmrentiva_settings', array( 'vendor_listing_duration_days' => 90 ));
