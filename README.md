...
![Version](https://img.shields.io/badge/version-4.64.0-blue.svg)
...
- **PHPUnit**: 1,405 tests / 4,118 assertions (v4.64.0)
...
├── tests/                  # PHPUnit suite (1,241 tests, 3,743 assertions)
