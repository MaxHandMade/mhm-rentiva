...
if (file_exists(dirname(__FILE__) . '/src/Admin/Utilities/Uninstall/Uninstaller.php')) {
    require_once dirname(__FILE__) . '/src/Admin/Utilities/Uninstall/Uninstaller.php';
