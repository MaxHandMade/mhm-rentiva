	...
	function ($) {
		...
		var bulkActions = {
			...
			markAsRead: function (selectedItems) {
				...
				var messageIds = selectedItems.map(
					function () {
						return $( this ).val();
					}
				).get();
		...
		var quickReply = {
			...
			showQuickReplyForm: function (messageId) {
				...
				var form = $(
					'<div id="quick-reply-modal" class="quick-reply-modal">' +
