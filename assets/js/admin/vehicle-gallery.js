...
(function ($) {
    ...
    function initializeVehicleGallery() {
        ...
        $(document).on('click', '.mhm-gallery-add-btn', function (e) {
            e.preventDefault();
            openMediaLibrary();
        });

        // Görsel kaldırma butonu
        $(document).on('click', '.mhm-gallery-remove-btn', function (e) {
            e.preventDefault();
        ...
        $(document).on('click', '.mhm-gallery-item img', function () {
    ...
    function openMediaLibrary() {
        ...
        mediaUploader.on('select', function () {
            ...
            const imageIds = selection.map(function (attachment) {
    ...
    function showImagePreview(imageUrl) {
        ...
        // Kapatma butonu
        $preview.on('click', '.mhm-gallery-preview-close, .mhm-gallery-preview-overlay', function (e) {
            if (e.target === this) {
                $preview.remove();
            }
        });
        ...
        $(document).on('keyup.gallery-preview', function (e) {
            if (e.keyCode === 27) { // ESC
                $preview.remove();
    ...
    function showNotification(message, type = 'info') {
        ...
        // Manuel kapatma
        $notification.on('click', '.mhm-gallery-notification-close', function () {
            $notification.fadeOut(300, function () {
                $(this).remove();
            });
        });
