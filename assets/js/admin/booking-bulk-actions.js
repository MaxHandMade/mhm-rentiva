...
(function ($) {
    ...
    $(function () {
        ...
        $bulkButtons.on('click.mhmBookingBulk', function (event) {
        ...
        if ($deleteAll.length) {
            $deleteAll.off('click').on('click.mhmBookingBulk', function (event) {
                if (strings.confirm_empty_trash && !window.confirm(strings.confirm_empty_trash)) {
                    event.preventDefault();
                    return false;
                }
        ...
        $('.row-actions .trash a').off('click.mhmBookingBulk').on('click.mhmBookingBulk', function (event) {
        ...
        $('.row-actions .delete a').off('click.mhmBookingBulk').on('click.mhmBookingBulk', function (event) {
