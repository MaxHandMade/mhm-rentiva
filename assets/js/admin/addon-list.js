...
jQuery(document).ready(function ($) {
    ...
    var inlineEdit = {
        ...
        bindEvents: function () {
            ...
            $(document).on('dblclick', '.addon-price-display', function () {
                inlineEdit.startEdit($(this));
            });

            // Enter tuşu ile kaydet
            $(document).on('keypress', '.addon-price-input', function (e) {
                if (e.which === 13) { // Enter
            ...
            $(document).on('keyup', '.addon-price-input', function (e) {
            ...
            $(document).on('blur', '.addon-price-input', function () {
                inlineEdit.saveEdit($(this));
            });
        },
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        var formattedPrice = newPrice.toLocaleString(mhm_addon_list_vars.locale || 'en-US', {
        ...
        cancelEdit: function ($input) {
            ...
            var formattedPrice = originalPrice.toLocaleString(mhm_addon_list_vars.locale || 'en-US', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            }) + ' ' + currency;
            $element.html(formattedPrice);
    ...
    var bulkActions = {
        ...
        enableAddons: function (selectedItems) {
            ...
            var addonIds = selectedItems.map(function () {
                return $(this).val();
            }).get();
    ...
    var quickEdit = {
        ...
        bindEvents: function () {
            ...
            $('.quick-edit-addon').on('click', function (e) {
                e.preventDefault();
    ...
    var licenseWarning = {
        ...
        showLicenseWarning: function () {
            var warning = $('<div class="notice notice-warning is-dismissible">' +
