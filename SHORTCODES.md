...
**// | `rentiva_booking_confirmation` | reservation | No | Booking confirmation | //** Silinecek
...
| `rentiva_vendor_apply` | vendor | No | Vendor application form |
| `rentiva_vehicle_submit` | vendor | Yes | Vendor vehicle submission |
