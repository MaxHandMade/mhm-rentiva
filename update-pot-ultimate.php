...
$allowed_extensions = array( 'php', 'js' ); // Hem PHP hem JS dosyalarına bak

// --- İŞLEM BAŞLIYOR ---

if ( ! file_exists( $pot_file_path ) ) {
	die( '❌ POT dosyası bulunamadı!' );
}
...
if ( $added_count == 0 ) {
	echo "<div style='background:#eee; padding:10px;'>ℹ️ POT dosyası güncel.</div>";
} else {
	echo "<div style='background:#dff0d8; padding:10px;'>🎉 $added_count yeni terim eklendi!</div>";
}
