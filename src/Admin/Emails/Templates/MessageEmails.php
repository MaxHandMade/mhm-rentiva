    ...
    public static function render(): void
    {
        ...
        $admin_fields = [
            ...
            [
                ...
                'value' => $get_val('mhm_rentiva_message_received_admin_body', [EmailSettings::class, 'get_default_message_admin_body'], 'message_body'),
                'rows' => 10,
            ],
        ];
        ...
        $customer_fields = [
            ...
            [
                ...
                'value' => $get_val('mhm_rentiva_message_replied_customer_body', [EmailSettings::class, 'get_default_message_customer_body'], 'reply_body'),
                'rows' => 10,
            ],
        ];
        ...
        $auto_reply_fields = [
            ...
            [
                ...
                'value' => $get_val('mhm_rentiva_message_auto_reply_body', [EmailSettings::class, 'get_default_message_auto_reply_body']),
                'rows' => 10,
            ],
        ];
