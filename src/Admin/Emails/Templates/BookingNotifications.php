    ...
    public static function render(): void
    {
        ...
        $booking_created_fields = [
            ...
            [
                ...
                'value' => $get_val('mhm_rentiva_booking_created_body', [EmailSettings::class, 'get_default_customer_confirmation_body'], '<table'),
                'rows' => 12,
            ],
        ];
        ...
        $booking_status_fields = [
            ...
            [
                ...
                'label' => __('Content (HTML)', 'mhm-rentiva'),
                'value' => $get_val('mhm_rentiva_booking_status_body', [EmailSettings::class, 'get_default_booking_status_body'], 'border-radius'),
                'rows' => 12,
            ],
        ];
        ...
        $booking_admin_fields = [
            ...
            [
                ...
                'label' => __('Content (HTML)', 'mhm-rentiva'),
                'value' => $get_val('mhm_rentiva_booking_admin_body', [EmailSettings::class, 'get_default_admin_notification_body'], 'background:'),
                'rows' => 12,
            ],
        ];
        ...
        $auto_cancel_fields = [
            ...
            [
                ...
                'label' => __('Content (HTML)', 'mhm-rentiva'),
                'value' => $get_val('mhm_rentiva_auto_cancel_email_content', [EmailSettings::class, 'get_default_auto_cancel_body'], 'color:'),
                'rows' => 10,
            ],
        ];
        ...
        $cancelled_fields = [
            ...
            [
                ...
                'label' => __('Content (HTML)', 'mhm-rentiva'),
                'value' => $get_val('mhm_rentiva_booking_cancelled_body', [EmailSettings::class, 'get_default_booking_cancelled_body'], '<table'),
                'rows' => 12,
            ],
        ];
        ...
        $reminder_fields = [
            ...
            [
                ...
                'label' => __('Content (HTML)', 'mhm-rentiva'),
                'value' => $get_val('mhm_rentiva_booking_reminder_body', [EmailSettings::class, 'get_default_booking_reminder_body'], 'background:'),
                'rows' => 12,
            ],
        ];
        EmailFormRenderer::render_form(
        ...
        $welcome_fields = [
            ...
            [
                ...
                'label' => __('Content (HTML)', 'mhm-rentiva'),
                'value' => $get_val('mhm_rentiva_welcome_email_body', [EmailSettings::class, 'get_default_welcome_email_body'], 'community'),
                'rows' => 12,
            ],
        ];
        EmailFormRenderer::render_form(
