...
final class Mailer
{
     ...
     */
    public static function send(string $key, string $to, array $context = [], array $headers = []): bool
    {
        ...
        if (isset($context['customer']['email']) && $context['customer']['email'] === $to) {
            ...
            if ($user) {
                ...
                if (in_array($key, ['booking_confirmation', 'booking_reminder', 'booking_cancellation'])) {
                ...
                if (in_array($key, ['booking_confirmation', 'booking_reminder', 'booking_cancellation']) && !self::is_booking_notifications_enabled()) {
                    return false;
                }
     ...
     * @return bool Success status
     */
    public static function sendBookingEmail(string $template_key, int $booking_id, string $recipient_type, array $additional_context = []): bool
    {
