...
final class EmailAjaxHandler
{
    ...
    {
        add_action('wp_ajax_mhm_rentiva_preview_email_ajax', [self::class, 'handle_preview_email']);
        add_action('wp_ajax_mhm_rentiva_send_test_email_ajax', [self::class, 'handle_send_test_email']);
    }
