...
final class ReminderScheduler
{
    ...
    {
        add_action('mhm_rentiva_booking_created', [self::class, 'schedule_reminder']);
        add_action('mhm_rentiva_send_booking_reminder', [self::class, 'send_reminder']);
    }
    ...
    public static function schedule_reminder(int $booking_id): void
    {
        ...
        wp_schedule_single_event($when, 'mhm_rentiva_send_booking_reminder', [$booking_id]);
    }
