...
final class AccountController {
	...
	public static function register(): void {
		...
		// Register shortcodes
		add_shortcode( 'rentiva_my_bookings', array( self::class, 'render_my_bookings' ) );
		add_shortcode( 'rentiva_my_favorites', array( self::class, 'render_my_favorites' ) );
		add_shortcode( 'rentiva_payment_history', array( self::class, 'render_payment_history' ) );
		add_shortcode( 'rentiva_messages', array( self::class, 'render_messages' ) );
		...
		add_action( 'wp_ajax_mhm_cancel_booking', array( self::class, 'ajax_cancel_booking' ) );
	 ...
	 */
	public static function render_my_bookings( array $atts = array() ): string {
		if ( ! is_user_logged_in() ) {
			return '<p>' . esc_html__( 'Please login to view your bookings.', 'mhm-rentiva' ) . '</p>';
		}
	 ...
	 */
	public static function render_my_favorites( array $atts = array() ): string {
		if ( ! is_user_logged_in() ) {
			return '<p>' . esc_html__( 'Please login to view your favorites.', 'mhm-rentiva' ) . '</p>';
		}
	...
	public static function render_payment_history( array $atts = array() ): string {
		if ( ! is_user_logged_in() ) {
			return '<p>' . esc_html__( 'Please login to view your payment history.', 'mhm-rentiva' ) . '</p>';
		}
	...
	public static function render_messages( array $atts = array() ): string {
		if ( ! is_user_logged_in() ) {
			return '<p>' . esc_html__( 'Please login to view your messages.', 'mhm-rentiva' ) . '</p>';
		}
