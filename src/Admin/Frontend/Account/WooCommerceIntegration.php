...
final class WooCommerceIntegration {
	...
	public static function register(): void {
		...
		add_action( 'woocommerce_account_' . self::get_endpoint_slug( 'bookings', 'my-vehicle-bookings' ) . '_endpoint', array( self::class, 'render_bookings' ) );
		add_action( 'woocommerce_account_' . self::get_endpoint_slug( 'favorites', 'my-favorite-vehicles' ) . '_endpoint', array( self::class, 'render_favorites' ) );
		add_action( 'woocommerce_account_' . self::get_endpoint_slug( 'payment_history', 'my-payment-history' ) . '_endpoint', array( self::class, 'render_payment_history' ) );
		add_action( 'woocommerce_account_' . self::get_endpoint_slug( 'messages', 'my-messages' ) . '_endpoint', array( self::class, 'render_messages' ) );
		add_action( 'woocommerce_account_' . self::get_endpoint_slug( 'view_booking', 'view-vehicle-booking' ) . '_endpoint', array( self::class, 'render_view_booking' ) );
	...
	public static function render_view_booking( $booking_id ): void {
		...
		echo wp_kses_post( AccountRenderer::render_booking_detail( (int) $id, true ) );
	}
	...
	public static function get_endpoint_slug( string $key, string $default ): string {
		...
		if ( empty( $slug ) ) {
			...
			$slug = match ( $key ) {
				'bookings'        => _x( 'my-vehicle-bookings', 'endpoint slug', 'mhm-rentiva' ),
				'favorites'       => _x( 'my-favorite-vehicles', 'endpoint slug', 'mhm-rentiva' ),
				'payment_history' => _x( 'my-payment-history', 'endpoint slug', 'mhm-rentiva' ),
				'messages'        => _x( 'my-messages', 'endpoint slug', 'mhm-rentiva' ),
				'view_booking'    => _x( 'view-vehicle-booking', 'endpoint slug', 'mhm-rentiva' ),
				default           => $default,
			};
		}
