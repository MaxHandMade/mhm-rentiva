...
{
    // Shortcode cache
    private static array $shortcode_cache = [];
    ...
    {
        $tag = static::get_shortcode_tag();
        $clean_tag = str_replace(['rentiva_', '_'], ['', ''], $tag);
     ...
     */
    protected static function ajax_success(array $data = [], string $message = ''): void
    {
        $response = $data;
     ...
     */
    protected static function ajax_error(string $message = '', array $data = []): void
    {
        $response = $data;
     ...
     * Debug helper
     */
    protected static function debug_log(string $message, array $data = []): void
    {
    ...
    public static function get_usage_stats(): array
    {
        ...
        return [
            ...
            'css_files' => array_filter(static::get_css_files(), [static::class, 'asset_exists']),
            'js_files' => array_filter(static::get_js_files(), [static::class, 'asset_exists']),
