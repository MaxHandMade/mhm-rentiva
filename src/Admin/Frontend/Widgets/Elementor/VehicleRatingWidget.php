...
class VehicleRatingWidget extends ElementorWidgetBase {



	public function get_name(): string {
		return 'rv-vehicle-rating';
	}

	public function get_title(): string {
		return __( 'Vehicle Rating Form', 'mhm-rentiva' );
	}
	...
	protected function register_content_controls(): void {
		...
		$this->add_control(
			...
			array(
				...
				'type'        => 'text',
				'description' => __( 'Leave empty for current vehicle', 'mhm-rentiva' ),
			)
		);
	...
	protected function render(): void {
		...
		echo $this->render_shortcode( 'rentiva_vehicle_rating_form', $atts );
	}
}
