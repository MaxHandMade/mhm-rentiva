...
WHERE meta_key = %s AND meta_value != ''
		...
		return array(
			...
			'sections'    => array(
				...
				array(
					'type'          => 'custom',
					'custom_render' => array( self::class, 'render_action_buttons' ),
				),
			),
		);
	}
