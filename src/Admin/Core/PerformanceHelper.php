...
final class PerformanceHelper
{
     ...
     */
    public static function cache_set(string $key, $data, int $duration = null, array $tags = []): bool
    {
     ...
     * @return bool Success
     */
    public static function cache_set_multiple(array $items, int $duration = null, array $tags = []): bool
    {
        $success = true;
    ...
    public static function batch_load_vehicle_data(array $vehicle_ids): array
    {
        ...
        if (!empty($missing_ids)) {
            ...
            self::cache_set_multiple($cache_items, self::DEFAULT_CACHE_DURATION, ['vehicles']);
        }
    ...
    private static function load_vehicle_data_batch(array $vehicle_ids): array
    {
        ...
        $meta_data = $wpdb->get_results($meta_sql, ARRAY_A);
        $meta_by_post_id = [];
    ...
    public static function batch_load_availability_data(array $vehicle_ids, string $start_date, string $end_date): array
    {
        ...
        ", array_merge($vehicle_ids, [$end_date, $start_date]));
        ...
        foreach ($bookings as $booking) {
            ...
            if (!isset($availability_by_vehicle[$vehicle_id])) {
                $availability_by_vehicle[$vehicle_id] = [];
            }
     ...
     */
    public static function optimize_query(string $sql, array $params = []): array
    {
