...
final class I18nHelper {
	...
	public static function _e( string $text, string $domain = self::TEXT_DOMAIN ): void {
        // phpcs:ignore WordPress.Security.EscapeOutput.UnsafePrintingFunction, WordPress.WP.I18n.NonSingularStringLiteralText, WordPress.WP.I18n.NonSingularStringLiteralDomain
	...
	public static function _ex( string $text, string $context, string $domain = self::TEXT_DOMAIN ): void {
        // phpcs:ignore WordPress.Security.EscapeOutput.UnsafePrintingFunction, WordPress.WP.I18n.NonSingularStringLiteralText, WordPress.WP.I18n.NonSingularStringLiteralContext, WordPress.WP.I18n.NonSingularStringLiteralDomain
	...
	public static function _n( string $single, string $plural, int $number, string $domain = self::TEXT_DOMAIN ): string {
        // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralSingle, WordPress.WP.I18n.NonSingularStringLiteralPlural, WordPress.WP.I18n.NonSingularStringLiteralDomain
	...
	public static function _en( string $single, string $plural, int $number, string $domain = self::TEXT_DOMAIN ): void {
        // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, WordPress.WP.I18n.NonSingularStringLiteralSingle, WordPress.WP.I18n.NonSingularStringLiteralPlural, WordPress.WP.I18n.NonSingularStringLiteralDomain
	...
	public static function _nx( string $single, string $plural, int $number, string $context, string $domain = self::TEXT_DOMAIN ): string {
        // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralSingle, WordPress.WP.I18n.NonSingularStringLiteralPlural, WordPress.WP.I18n.NonSingularStringLiteralContext, WordPress.WP.I18n.NonSingularStringLiteralDomain
	...
	public static function _enx( string $single, string $plural, int $number, string $context, string $domain = self::TEXT_DOMAIN ): void {
        // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, WordPress.WP.I18n.NonSingularStringLiteralSingle, WordPress.WP.I18n.NonSingularStringLiteralPlural, WordPress.WP.I18n.NonSingularStringLiteralContext, WordPress.WP.I18n.NonSingularStringLiteralDomain
		echo esc_html( _nx( $single, $plural, $number, $context, $domain ) );
	}
	...
	public static function printf( string $text, ...$args ): void {
		...
		echo wp_kses_post( vsprintf( self::__( $text ), $args ) );
	}
	...
	public static function esc_html_printf( string $text, ...$args ): void {
        // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		echo esc_html( vsprintf( self::esc_html__( $text ), $args ) );
	}
	...
	public static function esc_attr_printf( string $text, ...$args ): void {
        // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		echo esc_attr( vsprintf( self::esc_attr__( $text ), $args ) );
	}
