...
// phpcs:disable WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- Booking query helper intentionally composes bounded lookup/reporting queries.
...
final class BookingQueryHelper {
	...
	public static function findBookingsByDateRange(
		...
		$query_args = array(
			...
			'orderby'        => array( 'pickup_date_range' => 'ASC' ),
		);
