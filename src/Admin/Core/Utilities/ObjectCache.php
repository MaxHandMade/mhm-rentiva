...
/**
 * ✅ OBJECT CACHE ENTEGRASYONU - Redis/Memcached Desteği
 * 
 * WordPress object cache API'sini genişleterek Redis ve Memcached desteği
 */
final class ObjectCache
{
    /**
     * Cache backend türleri
     */
    ...
    {
        return 24 * HOUR_IN_SECONDS; // 24 saat sabit kalabilir
    }
    ...
    public static function detect_backend(): string
    {
        ...
        // WordPress object cache kontrolü
    ...
    public static function flush_group(string $group): bool
    {
        ...
        switch ($backend) {
            ...
            case self::BACKEND_WP_CACHE:
                ...
                self::log_cache_notice('Object cache backend does not support group flush', [
                    'backend' => $backend,
                    'group' => $group,
                ]);
    ...
    public static function flush(): bool
    {
        ...
        switch ($backend) {
            ...
            case self::BACKEND_WP_CACHE:
                ...
                if ($flushed > 0) {
                    self::log_cache_notice('Object cache groups flushed', [
                        'backend' => $backend,
                ...
                if (apply_filters('mhm_rentiva_object_cache_allow_global_flush', false, $backend)) {
                    ...
                    self::log_cache_notice('Global object cache flush executed', [
                        'backend' => $backend,
                        'result' => (bool) $result,
                    ]);
                ...
                self::log_cache_notice('Global object cache flush skipped', [
                    'backend' => $backend,
                ]);
    ...
    /**
     * Grup pattern ile transient temizle
     */
    ...
    /**
     * MHM Rentiva transient'larını temizle
     */
    ...
    /**
     * Plugin için kayıtlı cache grupları
     */
    ...
    /**
     * Cache sıcaklığı (hot/cold cache detection)
     */
