...
?>
        <div class="mhm-settings-tab-header">
            <div class="mhm-settings-title-group">
                ...
                <p class="description"><?php esc_html_e('Configure workflow rules for internal communication and email notifications.', 'mhm-rentiva'); ?></p>
            </div>
            ...
            <div class="mhm-settings-header-actions">
                ...
                <button type="button" class="button button-secondary mhm-reset-messages-btn">
                    ...
                    <?php esc_html_e('Reset Conversations', 'mhm-rentiva'); ?>
                </button>
            </div>
        </div>
        ...
        <div class="mhm-messages-settings-container">
            ...
            <form method="post" action="options.php" class="mhm-settings-form mhm-tabbed-form" id="mhm-messages-settings-form">
                ...
                <div class="submit-section" style="margin-top: 30px;">
                    <?php submit_button(__('Save Communication Settings', 'mhm-rentiva'), 'primary', 'submit', true, ['id' => 'mhm-save-messages-btn']); ?>
                </div>
            </form>
        </div>
<?php
    ...
    private function enqueue_messages_assets(): void
    {
        ...
        wp_enqueue_style('mhm-messages-settings', esc_url($url . 'assets/css/admin/messages-settings.css'), [], $version);
        wp_enqueue_script('mhm-messages-settings', esc_url($url . 'assets/js/admin/messages-settings.js'), ['jquery'], $version, true);
