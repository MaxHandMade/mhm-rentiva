...
<?php
    ...
    private function enqueue_cleanup_assets(): void
    {
        ...
        wp_enqueue_style('mhm-database-cleanup', esc_url($url . 'assets/css/admin/database-cleanup.css'), [], $version);
        wp_enqueue_script('mhm-database-cleanup', esc_url($url . 'assets/js/admin/database-cleanup.js'), ['jquery'], $version, true);
