...
final class Settings
{
    ...
    public static function render_settings_page(): void
    {
        ...
        if (isset($_GET['settings-updated']) && self::sanitize_text_field_safe(wp_unslash($_GET['settings-updated'] ?? '')) === 'true') {
        ...
        if (isset($_POST['email_templates_action']) && self::sanitize_text_field_safe(wp_unslash($_POST['email_templates_action'] ?? '')) === 'save' && wp_verify_nonce($_POST['_wpnonce'], self::GROUP . '-options')) {
        ...
        // ✅ WordPress Settings API will be used - manual form handling removed
                ...
                <?php if ($current_tab === 'email-templates'): ?>
                    <div class="mhm-settings-form-container">
                        <form method="post" action="" class="mhm-settings-form" id="mhm-email-templates-form">
                            ...
                            echo '<input type="hidden" name="option_page" value="' . esc_attr(self::GROUP) . '" />';
     ...
     */
    private static function render_section(string $section_name): void
    {
        global $wp_settings_sections, $wp_settings_fields;
        
        if (!isset($wp_settings_sections[self::PAGE][$section_name])) {
            return;
        }
        
        $section = $wp_settings_sections[self::PAGE][$section_name];
        ...
        if (!isset($wp_settings_fields[self::PAGE][$section_name])) {
            return;
        }
        ...
        if (isset($wp_settings_fields[self::PAGE][$section_name])) {
            foreach ($wp_settings_fields[self::PAGE][$section_name] as $field) {
                echo '<tr>';
     ...
     */
    private static function render_vehicle_pricing_settings(): void
    {
     ...
     */
    private static function render_rest_settings(): void
    {
     ...
     */
    private static function render_api_keys_section(): void
    {
     ...
     */
    private static function render_endpoints_section(): void
    {
     ...
     */
    private static function render_section_clean(string $section_name): void
    {
        global $wp_settings_sections, $wp_settings_fields;
     ...
     */
    private static function render_email_templates_tab(): void
    {
     ...
     */
    private static function render_vehicle_management_settings(): void
    {
     ...
     */
    private static function render_customer_management_settings(): void
    {
        echo '<div class="mhm-settings-tab-header">';
        echo '<div>';
     ...
     */
    private static function render_payment_settings(): void
    {
     ...
     */
    private static function render_messages_settings(): void
    {
     ...
     * Render testing page
     */
    private static function render_testing_page(): void
    {
     ...
     */
    private static function render_database_cleanup_page(): void
    {
     ...
     */
    private static function render_cron_monitor_page(): void
    {
        // Enqueue scripts
        wp_enqueue_script(
            'mhm-cron-monitor',
     ...
     */
    private static function render_general_settings(): void
    {
        echo '<div class="mhm-settings-tab-header">';
     ...
     */
    private static function render_booking_settings(): void
    {
        echo '<div class="mhm-settings-tab-header">';
        echo '<div>';
     ...
     */
    private static function render_tab_reset_button(string $tab): void
    {
        echo '<div class="mhm-settings-tab-header">';
        echo '<div></div>'; // Empty div for spacing
