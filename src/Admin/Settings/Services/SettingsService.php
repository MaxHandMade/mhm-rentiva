...
final class SettingsService {
	...
	public static function reset_defaults( string $target_tab ): bool {
		...
		$provider_class = match ( $target_tab ) {
			...
			// the class was a hollow stub with no reachable tab slot;
			// 'customer' now falls through to
	...
	public static function initialize_defaults_on_activation(): void {
		...
		$provider_classes = array(
			...
			// CustomerManagementSettings::class was removed here:
			// get_default_settings() returned array() -- contributing nothing
			// to $defaults below.
