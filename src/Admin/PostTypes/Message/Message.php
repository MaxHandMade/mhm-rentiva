...
final class Message
{
    ...
    {
        add_action('init', [self::class, 'register_now']);
    }
    ...
    public static function register_now(): void
    {
        register_post_type(self::POST_TYPE, [
            ...
            'capabilities' => [
                'create_posts' => 'manage_options', // Sadece admin'ler oluşturabilir
            ],
            'map_meta_cap' => true,
        ]);
    }
    ...
    /**
     * İzin verilen mesaj kategorileri
     * MessagesSettings'ten gerçek ayarları al
     */
