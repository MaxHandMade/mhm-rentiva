...
final class AdvancedLogger
{
     ...
     * Performance metrics.
     */
    private static array $performance_metrics = [];
    ...
    public static function log(array $args): int
    {
        ...
        if ($include_stack_trace && in_array($level, [self::LEVEL_ERROR, self::LEVEL_CRITICAL])) {
     ...
     */
    public static function error(string $message, array $context = [], string $category = self::CATEGORY_SYSTEM): int
    {
        return self::log([
     ...
     */
    public static function critical(string $message, array $context = [], string $category = self::CATEGORY_SYSTEM): int
    {
        return self::log([
     ...
     */
    public static function warning(string $message, array $context = [], string $category = self::CATEGORY_SYSTEM): int
    {
        return self::log([
     ...
     */
    public static function info(string $message, array $context = [], string $category = self::CATEGORY_SYSTEM): int
    {
        return self::log([
            'level' => self::LEVEL_INFO,
            'category' => $category,
     ...
     */
    public static function debug(string $message, array $context = [], string $category = self::CATEGORY_SYSTEM): int
    {
        return self::log([
     ...
     */
    public static function security(string $message, array $context = []): int
    {
        return self::log([
            'level' => self::LEVEL_WARNING,
     ...
     */
    public static function api(string $message, array $context = []): int
    {
        return self::log([
            'level' => self::LEVEL_INFO,
     ...
     */
    public static function payment(string $message, array $context = [], int $booking_id = 0): int
    {
        return self::log([
            'level' => self::LEVEL_INFO,
     ...
     */
    public static function booking(string $message, array $context = [], int $booking_id = 0): int
    {
        return self::log([
            'level' => self::LEVEL_INFO,
     ...
     */
    public static function vehicle(string $message, array $context = [], int $vehicle_id = 0): int
    {
        return self::log([
            'level' => self::LEVEL_INFO,
     ...
     */
    public static function customer(string $message, array $context = [], int $customer_id = 0): int
    {
        return self::log([
            'level' => self::LEVEL_INFO,
    ...
    public static function add(array $args): int
    {
        ...
        $category = ($gateway === 'payment') ? self::CATEGORY_PAYMENT : self::CATEGORY_SYSTEM;
        ...
        $context = array_merge(($args['context'] ?? []), [
            'gateway'      => $gateway,
            'action'       => $action,
            'status'       => $status,
