...
final class PaymentException extends MHMException {
	 ...
	 * @return static
	 */
	public static function gatewayError( string $gateway, string $reason, array $context = array() ): self {
		return new self(
	 ...
	 * @return static
	 */
	public static function invalidAmount( float $amount, array $context = array() ): self {
		return new self(
			/* translators: %s placeholder. */
			sprintf( __( 'Invalid amount: %s', 'mhm-rentiva' ), number_format( $amount, 2 ) ),
			self::CODE_INVALID_AMOUNT,
			null,
			array_merge( $context, array( 'amount' => $amount ) )
		);
	}
	 ...
	 * @return static
	 */
	public static function cardDeclined( string $reason, array $context = array() ): self {
		return new self(
			/* translators: %s placeholder. */
			sprintf( __( 'Card declined: %s', 'mhm-rentiva' ), $reason ),
			self::CODE_CARD_DECLINED,
			null,
			array_merge( $context, array( 'decline_reason' => $reason ) )
		);
	}
	 ...
	 * @return static
	 */
	public static function insufficientFunds( float $required_amount, float $available_amount, array $context = array() ): self {
		return new self(
	 ...
	 * @return static
	 */
	public static function expiredCard( string $expiry_date, array $context = array() ): self {
		return new self(
			/* translators: %s placeholder. */
			sprintf( __( 'Card expired: %s', 'mhm-rentiva' ), $expiry_date ),
			self::CODE_EXPIRED_CARD,
			null,
			array_merge( $context, array( 'expiry_date' => $expiry_date ) )
		);
	}
	 ...
	 * @return static
	 */
	public static function invalidCard( string $reason, array $context = array() ): self {
		return new self(
			/* translators: %s placeholder. */
			sprintf( __( 'Invalid card: %s', 'mhm-rentiva' ), $reason ),
			self::CODE_INVALID_CARD,
			null,
			array_merge( $context, array( 'reason' => $reason ) )
		);
	}
	 ...
	 * @return static
	 */
	public static function networkError( string $reason, array $context = array() ): self {
		return new self(
			/* translators: %s placeholder. */
	 ...
	 * @return static
	 */
	public static function timeout( int $timeout_seconds, array $context = array() ): self {
		return new self(
			/* translators: %d placeholder. */
			sprintf( __( 'Payment timeout: %d seconds', 'mhm-rentiva' ), $timeout_seconds ),
			self::CODE_TIMEOUT,
			null,
			array_merge( $context, array( 'timeout_seconds' => $timeout_seconds ) )
		);
	}
	 ...
	 * @return static
	 */
	public static function configurationError( string $config_key, array $context = array() ): self {
		return new self(
			/* translators: %s placeholder. */
			sprintf( __( 'Payment configuration error: %s', 'mhm-rentiva' ), $config_key ),
			self::CODE_CONFIGURATION_ERROR,
			null,
			array_merge( $context, array( 'config_key' => $config_key ) )
		);
	}
}
