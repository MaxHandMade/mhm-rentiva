...
final class OfflinePaymentSettings
{
    public static function register(): void
    {
        ...
        SettingsHelper::textarea_field($group, 'mhm_rentiva_offline_instructions', __('Payment Instructions', 'mhm-rentiva'), 5, __('Payment instructions to display to customers', 'mhm-rentiva'), 'mhm_rentiva_offline_section');
