...
final class VehicleSearch
{
    ...
    public static function register(): void
    {
        ...
        add_action('wp_ajax_mhm_rentiva_search_vehicles', [self::class, 'ajax_search_vehicles']);
        add_action('wp_ajax_nopriv_mhm_rentiva_search_vehicles', [self::class, 'ajax_search_vehicles']);
    }

    public static function enqueue_assets($atts = []): void
    {
        ...
        wp_localize_script($script_handle, 'mhmRentivaSearch', [
            ...
            'datepicker_options' => [
                ...
                'dayNames'   => [__('Sunday', 'mhm-rentiva'), __('Monday', 'mhm-rentiva'), __('Tuesday', 'mhm-rentiva'), __('Wednesday', 'mhm-rentiva'), __('Thursday', 'mhm-rentiva'), __('Friday', 'mhm-rentiva'), __('Saturday', 'mhm-rentiva')],
                'dayNamesShort' => [__('Sun', 'mhm-rentiva'), __('Mon', 'mhm-rentiva'), __('Tue', 'mhm-rentiva'), __('Wed', 'mhm-rentiva'), __('Thu', 'mhm-rentiva'), __('Fri', 'mhm-rentiva'), __('Sat', 'mhm-rentiva')],
    ...
    private static function perform_search(array $params): array
    {
        ...
        $sort_mapping = [
            ...
            'price_desc' => ['meta_key' => '_mhm_rentiva_price_per_day', 'orderby' => 'meta_value_num', 'order' => 'DESC'],
