...
// phpcs:disable WordPress.DB.SlowDBQuery.slow_db_query_meta_query,WordPress.DB.SlowDBQuery.slow_db_query_meta_key,WordPress.DB.SlowDBQuery.slow_db_query_meta_value,WordPress.DB.SlowDBQuery.slow_db_query_tax_query,WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching -- Vehicle feature helper intentionally performs bounded feature/meta lookups.
...
final class VehicleFeatureHelper
{
	 ...
	 * @var array|null
	 */
	private static ?array $fields_map_cache = null;
	...
	{
		if (null === self::$fields_map_cache) {
			self::get_available_fields_map();
		}
	}
	...
	{
		if (null !== self::$fields_map_cache) {
			return self::$fields_map_cache;
		}

		$result = array(
			self::TYPE_DETAIL   => array(),
		...
		if (empty($selected_details)) {
			$selected_details = self::get_core_fields();
		}
	 ...
	 */
	public static function format_detail_value(string $key, $raw, array $context = array()): ?array
	{
		$text = '';
		$icon = 'default';
