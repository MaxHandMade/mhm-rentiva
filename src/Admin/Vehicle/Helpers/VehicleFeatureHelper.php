...
final class VehicleFeatureHelper
{
	...
	{
		return array(
			array('type' => self::TYPE_DETAIL, 'key' => 'fuel_type'),
			array('type' => self::TYPE_DETAIL, 'key' => 'transmission'),
			array('type' => self::TYPE_DETAIL, 'key' => 'seats'),
			array('type' => self::TYPE_DETAIL, 'key' => 'mileage'),
		);
	}
