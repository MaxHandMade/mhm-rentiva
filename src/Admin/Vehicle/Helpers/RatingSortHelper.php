...
// phpcs:disable WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- Rating sort helper intentionally uses bounded aggregate/meta queries for score computation.
