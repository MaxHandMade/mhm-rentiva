...
final class VehicleColumns
{
    ...
    {
        add_filter('manage_vehicle_posts_columns', [self::class, 'columns']);
        add_action('manage_vehicle_posts_custom_column', [self::class, 'render'], 10, 2);
        add_filter('manage_edit-vehicle_sortable_columns', [self::class, 'sortable']);
    ...
    private static function get_vehicle_stats(): array
    {
        ...
        $all_vehicles = $wpdb->get_results($wpdb->prepare("
    ...
    public static function save_quick_edit(int $post_id): void
    {
        ...
        $meta_fields = [
            'mhm_license_plate' => ['key' => '_mhm_rentiva_license_plate', 'sanitize' => 'sanitize_text_field'],
            'mhm_price_per_day' => ['key' => '_mhm_rentiva_price_per_day', 'sanitize' => 'floatval'],
            'mhm_seats' => ['key' => '_mhm_rentiva_seats', 'sanitize' => 'intval'],
            'mhm_transmission' => ['key' => '_mhm_rentiva_transmission', 'sanitize' => 'sanitize_text_field'],
            'mhm_fuel_type' => ['key' => '_mhm_rentiva_fuel_type', 'sanitize' => 'sanitize_text_field'],
            'mhm_available' => ['key' => '_mhm_vehicle_availability', 'sanitize' => 'sanitize_text_field']
        ];
