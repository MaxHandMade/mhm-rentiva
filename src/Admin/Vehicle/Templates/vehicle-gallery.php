...
<div class="mhm-vehicle-gallery-container">
	...
	<!-- Bulk Delete Toolbar -->
	<div class="gallery-bulk-toolbar" id="mhm-gallery-bulk-toolbar" style="display:none;">
		<label class="gallery-select-all-label">
			<input type="checkbox" id="mhm-gallery-select-all">
			<?php esc_html_e( 'Select All', 'mhm-rentiva' ); ?>
		</label>
		<button type="button" id="mhm-gallery-bulk-delete" class="button button-small gallery-bulk-delete-btn" disabled>
			<?php esc_html_e( 'Delete Selected', 'mhm-rentiva' ); ?>
			(<span id="mhm-gallery-selected-count">0</span>)
		</button>
	</div>
