...
final class Messages
{
	...
	public static function register(): void
	{
		...
		add_action('admin_notices', array(self::class, 'add_message_stats_cards'));
...
?>
	...
	{
		if (! current_user_can('manage_options')) {
			ErrorHandler::permission_error(esc_html__('You do not have permission to access this page.', 'mhm-rentiva'));
		}

		// Pro feature check
		if (! Mode::featureEnabled(Mode::FEATURE_MESSAGES)) {
			echo '<div class="wrap">';
			echo '<h1>' . esc_html__('Messages', 'mhm-rentiva') . '</h1>';
