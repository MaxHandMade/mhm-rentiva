...
final class MessageUrlHelper
{
     ...
     */
    public static function get_messages_list_url_with_filters(array $filters = []): string
    {
     ...
     */
    private static function get_admin_page_url(string $page, array $params = []): string
    {
