...
final class MessageNotifications {
	...
	public static function register(): void {
		// Hooks
		add_action( 'mhm_message_created', array( self::class, 'send_new_message_notifications' ), 10, 2 );
		add_action( 'mhm_message_status_changed', array( self::class, 'send_status_change_notifications' ), 10, 3 );
	}
