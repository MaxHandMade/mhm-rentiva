...
final class MessageLogger
{
	...
	public static function flush_log_buffer(): void
	{
		...
		if (! empty($values)) {
			// phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared -- Bulk insert values are individualy prepared.
	...
	public static function get_logs(array $args = array()): array
	{
		...
		if (! empty($where_values)) {
			...
			// phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- Table name is safe, where clause is safe.
