...
final class MessageListTable extends AbstractListTable
{
    ...
    protected function column_date($item): string
    {
        ...
        return sprintf(
            '<time datetime="%s" title="%s">%s ' . __('ago', 'mhm-rentiva') . '</time>',
            date('c', $date),
            date('d.m.Y H:i', $date),
            $human_date
        );
    ...
    protected function render_custom_filters(): void
    {
        ...
        <div class="alignleft actions">
            <select name="status_filter" id="status_filter">
                <option value=""><?php _e('All Statuses', 'mhm-rentiva'); ?></option>
            ...
            <select name="category_filter" id="category_filter">
                <option value=""><?php _e('All Categories', 'mhm-rentiva'); ?></option>
            ...
            <button type="submit" class="button"><?php _e('Filter', 'mhm-rentiva'); ?></button>
        </div>
        <?php
    }
