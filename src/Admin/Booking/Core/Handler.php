...
final class Handler {
	...
	private static function get_client_ip(): string {
		...
		// Fallback to REMOTE_ADDR with proper sanitization
		...
		return Locker::withLock(
			...
			function () use ( $booking_data ) {
				...
				$deposit_result = DepositCalculator::calculate_booking_deposit(
					...
					$booking_data['selected_addons'] ?? array(),
					$start_ts
				);
