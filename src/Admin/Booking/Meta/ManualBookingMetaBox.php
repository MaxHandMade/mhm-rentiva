...
final class ManualBookingMetaBox extends AbstractMetaBox
{
	...
	public static function render(\WP_Post $post, array $args = array()): void
	{
		...
		echo '<h4>' . esc_html__('New Customer Information', 'mhm-rentiva') . '</h4>';
		...
		echo '<h4>' . esc_html__('Price Calculation', 'mhm-rentiva') . '</h4>';
		...
		echo '<button type="button" id="mhm-create-booking" class="button button-primary" style="display: none;">' . esc_html__('Create Booking', 'mhm-rentiva') . '</button>';
		echo '</div>';
