...
final class LockoutManager
{
    ...
    {
        add_action('wp_login_failed', [self::class, 'handle_failed_login']);
        add_action('wp_login', [self::class, 'clear_failed_attempts']);
        add_filter('authenticate', [self::class, 'check_account_lockout'], 30, 3);
    }
