...
final class DashboardService {
	...
	public static function get_transfer_summary(): array {
		...
		// Total Transfer Bookings (identified by _mhm_transfer_origin_id meta presence)
		...
		$transfer_revenue = (float) $wpdb->get_var(
			$wpdb->prepare(
             ...
             FROM {$wpdb->posts} p
             INNER JOIN {$wpdb->postmeta} pm_transfer ON p.ID = pm_transfer.post_id AND pm_transfer.meta_key = '_mhm_transfer_origin_id'
