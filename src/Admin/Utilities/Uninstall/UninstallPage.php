...
final class UninstallPage
{
    ...
    {
        add_action('wp_ajax_mhm_get_uninstall_stats', [self::class, 'ajax_get_uninstall_stats']);
        add_action('wp_ajax_mhm_uninstall_plugin', [self::class, 'ajax_uninstall_plugin']);
    }
