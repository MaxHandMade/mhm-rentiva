...
final class Uninstaller
{
    ...
    public static function get_uninstall_stats(): array
    {
        ...
        $options = $wpdb->get_var("
            ...
            OR option_name LIKE '_mhm_rentiva%'
        ");
        ...
        $transients = $wpdb->get_var("
            SELECT COUNT(*) 
            FROM {$wpdb->options}
            WHERE (option_name LIKE '_transient_mhm_rentiva%' 
            OR option_name LIKE '_transient_timeout_mhm_rentiva%')
        ");
