...
final class VendorReportAssets {
    ...
    private static function i18n_strings(): array
    {
        return [
            ...
            'minChars'               => __('Minimum 20 characters.', 'mhm-rentiva'),
            'reasonOptionalHint'     => __('Optional. Leave empty to proceed and accept the penalty, or write at least 20 characters to appeal it.', 'mhm-rentiva'),
            ...
            'withdrawSubtitle'       => __('Withdrawing applies a penalty. Leave the reason empty to withdraw and accept the penalty, or explain why to appeal it — if the admin accepts your reason, no penalty applies.', 'mhm-rentiva'),
            'reasonForWithdrawal'    => __('Reason for withdrawal (optional)', 'mhm-rentiva'),
            ...
            'pauseSubtitle'          => __('Repeated pauses may incur a penalty. Leave the reason empty to pause and accept any penalty, or explain why to appeal it — if the admin accepts your reason, no penalty applies.', 'mhm-rentiva'),
            'reasonForPausing'       => __('Reason for pausing (optional)', 'mhm-rentiva'),
