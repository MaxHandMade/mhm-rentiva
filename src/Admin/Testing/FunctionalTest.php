...
// phpcs:disable WordPress.DB.SlowDBQuery.slow_db_query_meta_query,WordPress.DB.SlowDBQuery.slow_db_query_meta_key,WordPress.DB.SlowDBQuery.slow_db_query_meta_value,WordPress.DB.SlowDBQuery.slow_db_query_tax_query,WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching -- Functional test diagnostics intentionally run direct verification queries.
...
final class FunctionalTest {
	...
	public static function test_asset_enqueue(): array {
		...
		if ( $has_asset_manager ) {
			...
			$has_frontend_hook = has_action( 'wp_enqueue_scripts', array( 'MHMRentiva\\Admin\\Core\\AssetManager', 'enqueue_frontend_assets' ) );
			$has_admin_hook    = has_action( 'admin_enqueue_scripts', array( 'MHMRentiva\\Admin\\Core\\AssetManager', 'enqueue_admin_assets' ) );
