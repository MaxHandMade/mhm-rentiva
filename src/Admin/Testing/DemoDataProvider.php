    ...
    private static function vehicles_tr(): array
    {
        return array(
            ...
            array(
                ...
                'color'         => 'Gri',
                'engine_power'  => '122 HP',
                'license_plate' => '34 BB 002',
                'mileage'       => 12000,
                'seats'         => 5,
                'doors'         => 4,
                'transmission'  => 'automatic',
                'fuel_type'     => 'hybrid',
                'features'      => 'Klima, Navigasyon, Otonom Fren, Lane Assist',
            ...
            array(
                ...
                'color'         => 'Mavi',
                'engine_power'  => '136 HP',
                'license_plate' => '34 DD 004',
                'mileage'       => 22000,
                'seats'         => 5,
                'doors'         => 5,
                'transmission'  => 'automatic',
                'fuel_type'     => 'diesel',
                'features'      => 'Klima, Navigasyon, AWD, Apple CarPlay',
    ...
    private static function vehicles_en(): array
    {
        return array(
            ...
            array(
                ...
                'color'         => 'Gray',
                'engine_power'  => '122 HP',
                'license_plate' => 'CD34 EFG',
                'mileage'       => 12000,
                'seats'         => 5,
                'doors'         => 4,
                'transmission'  => 'automatic',
                'fuel_type'     => 'hybrid',
                'features'      => 'Air Conditioning, Navigation, Autonomous Braking, Lane Assist',
                'image_file'    => 'midrange-01.webp',
            ),
            array(
                'title'         => 'BMW 520i M Sport',
            ...
            array(
                ...
                'color'         => 'Blue',
                'engine_power'  => '136 HP',
                'license_plate' => 'GH78 IJK',
                'mileage'       => 22000,
                'seats'         => 5,
                'doors'         => 5,
                'transmission'  => 'automatic',
                'fuel_type'     => 'diesel',
                'features'      => 'Air Conditioning, Navigation, AWD, Apple CarPlay',
                'image_file'    => 'suv-01.webp',
            ),
            array(
                'title'         => 'Mercedes Vito Tourer',
