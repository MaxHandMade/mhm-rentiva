...
// phpcs:disable WordPress.DB.SlowDBQuery.slow_db_query_meta_query,WordPress.DB.SlowDBQuery.slow_db_query_meta_key,WordPress.DB.SlowDBQuery.slow_db_query_meta_value,WordPress.DB.SlowDBQuery.slow_db_query_tax_query,WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching -- Integration diagnostics intentionally run direct verification queries.
...
final class IntegrationTest {
	...
	public static function test_payment_gateways(): array {
		...
		$gateways['woocommerce'] = array(
			'exists'  => $has_woocommerce,
			'enabled' => $has_woocommerce,
		);
	...
	public static function test_user_roles(): array {
		$required_roles = array( 'customer', 'administrator' );
		$roles_found    = array();
		$roles_missing  = array();
