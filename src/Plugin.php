...
final class Plugin
{
    ...
    private function __construct()
    {
        ...
        add_filter('wp_insert_post_data', [$this, 'enforce_limits'], 10, 2);

        // Cache invalidation hooks
        add_action('save_post', [$this, 'invalidate_cache_on_save']);
        add_action('delete_post', [$this, 'invalidate_cache_on_delete']);
        add_action('updated_post_meta', [$this, 'invalidate_cache_on_meta_update'], 10, 4);
