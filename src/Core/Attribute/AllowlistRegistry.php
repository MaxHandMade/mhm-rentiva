...
final class AllowlistRegistry {
    ...
    public const ALLOWLIST = [
        ...
        'show_duration'            => [
            'type'    => 'bool',
            'group'   => 'visibility',
            'aliases' => [ 'showDuration' ],
        ],
        'show_distance'            => [
            'type'    => 'bool',
            'group'   => 'visibility',
            'aliases' => [ 'showDistance' ],
        ],
        'show_traffic_note'        => [
            'type'    => 'bool',
            'group'   => 'visibility',
        ...
        'filter_origin_city'       => [
            'type'    => 'string',
            'group'   => 'data',
            'aliases' => [ 'filterOriginCity' ],
        ],
        'filter_origin_type'       => [
            'type'    => 'string',
            'group'   => 'data',
            'aliases' => [ 'filterOriginType' ],
        ],
        'featured_only'            => [
            'type'    => 'bool',
            'group'   => 'feature',
            'aliases' => [ 'featuredOnly' ],
        ],
        'show_remove_button'       => [
            'type'    => 'bool',
            'group'   => 'visibility',
        ...
        'default_payment'          => [
            ...
            'values'  => [ 'deposit', 'full', 'cash', 'credit_card', 'bank_transfer', 'none' ],
        ],
        'redirect_url'             => [
            'type'    => 'string',
            'group'   => 'workflow',
