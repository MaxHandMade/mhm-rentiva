...
if ($profile_editable !== '1') {
	echo '<div class="' . esc_attr($wrapper_class) . '"><div class="mhm-account-content"><div class="section-header"><h2>' . esc_html__('Account Details', 'mhm-rentiva') . '</h2><p>' . esc_html__('Profile editing is currently disabled.', 'mhm-rentiva') . '</p></div></div></div>';
	return;
}
?>
...
<div class="<?php echo esc_attr($wrapper_class); ?>">
	...
	<div class="mhm-account-content">
		...
		<div class="section-header">
			<h2><?php esc_html_e('Account Details', 'mhm-rentiva'); ?></h2>
					...
					<div class="form-field">
						...
						<div class="password-requirements">
							<small>
								...
								printf(esc_html__('Minimum %d characters', 'mhm-rentiva'), absint($password_min_length));
								?>
								<?php if ($password_special === '1') : ?>
