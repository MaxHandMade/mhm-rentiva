...
<div class="mhm-rentiva-account-page">
    ...
    <div class="mhm-account-content">
        ...
        <div class="stats-grid">
            <div class="stat-card stat-card-total-bookings">
                ...
                <div class="stat-content">
                    <h3 class="stat-number"><?php echo esc_html($bookings_count); ?></h3>
            ...
            <div class="stat-card stat-card-active-bookings">
                ...
                <div class="stat-content">
                    <h3 class="stat-number"><?php echo esc_html($active_bookings_count); ?></h3>
            ...
            <div class="stat-card stat-card-total-favorites">
                ...
                <div class="stat-content">
                    <?php
                    if ($favorites === '1') {
                        $favorites_data = get_user_meta($user->ID, 'mhm_rentiva_favorites', true);
        ...
        <!-- Recent Bookings -->
        <?php if ($booking_history === '1'): ?>
        <div class="account-section">
            <div class="section-header">
                <h2><?php _e('Recent Bookings', 'mhm-rentiva'); ?></h2>
                    ...
                    <?php foreach ($recent_bookings as $booking): 
                        ...
                        switch ($status) {
                            case 'confirmed':
                                ...
                                $status_label = __('Confirmed', 'mhm-rentiva');
                                break;
                            case 'completed':
                                $status_class = 'status-completed';
                                $status_label = __('Completed', 'mhm-rentiva');
                                break;
                            case 'cancelled':
                                $status_class = 'status-cancelled';
                                $status_label = __('Cancelled', 'mhm-rentiva');
                                break;
                            default:
                                $status_class = 'status-pending';
                                $status_label = __('Pending', 'mhm-rentiva');
                        }
                    ?>
