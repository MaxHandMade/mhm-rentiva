...
jQuery(document).ready(function($) {
    ...
    confirmBtn.on('click', function() {
        ...
        // Disable button
        confirmBtn.prop('disabled', true).text('<?php esc_html_e('Cancelling...', 'mhm-rentiva'); ?>');
        statusMsg.hide();
        ...
        $.ajax({
            ...
            data: {
                ...
                reason: reason,
                nonce: '<?php echo wp_create_nonce('mhm_cancel_booking_nonce'); ?>'
            },
            ...
            error: function(xhr, status, error) {
                statusMsg.removeClass('rv-success').addClass('rv-error')
                    .html('❌ <?php esc_html_e('An error occurred. Please try again.', 'mhm-rentiva'); ?>')
                    .slideDown();
