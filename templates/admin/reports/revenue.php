            ...
            <div class="card-content">
                <div class="analytics-metrics">
                    <div class="metric-row">
                        ...
                        <span class="metric-value"><?php echo number_format((float)($data['total'] ?? 0), 0, ',', '.') . \MHMRentiva\Admin\Reports\Reports::get_currency_symbol(); ?></span>
                    </div>
                    <div class="metric-row">
                        <span class="metric-label">Daily Average</span>
                        <span class="metric-value"><?php echo number_format((float)(($data['total'] ?? 0) / max(1, count($data['daily'] ?? []))), 0, ',', '.') . \MHMRentiva\Admin\Reports\Reports::get_currency_symbol(); ?></span>
                    </div>
                </div>
            </div>
        </div>
