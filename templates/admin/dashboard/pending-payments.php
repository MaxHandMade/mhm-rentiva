			...
			<table class="wp-list-table widefat fixed striped">
				<thead>
					<tr>
						...
						<th><?php echo esc_html__( 'Remaining', 'mhm-rentiva' ); ?></th>
				...
				<tbody>
					...
					foreach ( $payments as $payment ) :
						...
						<tr class=”<?php echo esc_attr( $row_class ); ?>”>
							<td><strong><a href=”<?php echo esc_url( admin_url( 'post.php?post=' . (int) $payment['booking_id'] . '&action=edit' ) ); ?>”>#<?php echo esc_html( mhm_rentiva_get_display_id( (int) $payment['booking_id'] ) ); ?></a></strong></td>
