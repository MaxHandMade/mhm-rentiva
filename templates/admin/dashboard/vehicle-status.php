	...
	<div class="widget-content">
		<div class="vehicle-status-grid">
			...
			<div class="status-item inactive">
				<div class="status-icon"><span class="dashicons dashicons-dismiss"></span></div>
				<div class="status-info">
					<div class="status-number"><?php echo esc_html($vehicle_stats['inactive'] ?? 0); ?></div>
					<div class="status-label"><?php echo esc_html__('Inactive', 'mhm-rentiva'); ?></div>
				</div>
			</div>
		</div>
