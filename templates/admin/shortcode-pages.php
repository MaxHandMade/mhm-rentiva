					...
					<tr>
						...
						<td>
							<?php if ($page) : ?>
								...
								<br>
								<small class="mhm-page-id"><?php esc_html_e('ID:', 'mhm-rentiva'); ?> <?php echo absint($page_id); ?></small>
							<?php elseif ($has_url) : ?>
							...
							<div class="mhm-action-buttons">
								<?php if ($page) : ?>
									...
									<button type="button" class="button button-small button-link-delete mhm-btn-delete-page"
										data-page-id="<?php echo absint($page_id); ?>"
	...
	<div class="mhm-rentiva-stats-container">
		...
		<div class="mhm-stats-grid">
			<div class="card">
				...
				<h4><?php echo absint($total_count); ?></h4>
			</div>
			<div class="card">
				<p><?php esc_html_e('Active Pages', 'mhm-rentiva'); ?></p>
				<h4 style="color: #46b450;"><?php echo absint($active_count); ?></h4>
			</div>
			<div class="card">
				<p><?php esc_html_e('Missing Pages', 'mhm-rentiva'); ?></p>
				<h4 style="color: #dc3232;"><?php echo absint($missing_count); ?></h4>
			</div>
		</div>
	</div>
