	...
	<div class="content">
		...
		<table style="width: 100%; border-collapse: collapse; margin-bottom: 25px; background: #f8f9fa; border-radius: 8px;">
			...
			<tr>
				...
				<td style="padding: 12px 15px; border-bottom: 1px solid #e9ecef; text-align: right; color: #28a745; font-weight: bold;"><?php echo esc_html( \MHMRentiva\Admin\Core\CurrencyHelper::format_price( (float) ( $data['booking']['total_price'] ?? 0 ), 2 ) ); ?></td>
			</tr>
			<tr>
