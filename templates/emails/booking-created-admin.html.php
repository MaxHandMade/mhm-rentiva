	...
	<div class="content">
		...
		<table style="width: 100%; border-collapse: collapse; margin-bottom: 25px; background: #f8f9fa; border-radius: 8px;">
			...
			<tr>
				...
				<td style="padding: 12px 15px; border-bottom: 1px solid #e9ecef; text-align: right; color: #28a745; font-weight: bold;"><?php echo esc_html( apply_filters( 'mhmrentiva/currency_symbol', '₺' ) ); ?><?php echo esc_html( number_format( (float) ( $data['booking']['total_price'] ?? 0 ), 2 ) ); ?></td>
			</tr>
			<tr>
...
// phpcs:disable WordPress.NamingConventions.PrefixAllGlobals -- Template-scope variables are local render context.
		...
		<div style="text-align: center;">
			<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=mhmrentiva_booking' ) ); ?>" style="display: inline-block; background: #007bff; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; margin: 20px 0;"><?php esc_html_e( 'Manage Reservation', 'mhm-rentiva' ); ?></a>
		</div>
	</div>
</div>