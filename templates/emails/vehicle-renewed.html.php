...
<div class="content">
	...
	<p>
		<?php
		/* translators: 1: vehicle title, 2: duration days */
		echo esc_html(sprintf(__('Your listing for "%1$s" has been renewed for another %2$d days.', 'mhm-rentiva'), (string) ( $data['vehicle']['title'] ?? '' ), (int) ( $data['lifecycle']['duration_days'] ?? 90 )));
		?>
	</p>
