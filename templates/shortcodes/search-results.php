...
<div class="rv-search-results <?php echo esc_attr($atts['class'] ?? ''); ?> <?php echo !empty($is_compact) ? 'rv-compact-mode' : ''; ?>" id="rv-search-results">
				...
				<div id="rv-results-grid-content" class="rv-vehicle-grid-wrapper">
					<?php if (! empty($vehicles)) : ?>
						<?php foreach ($vehicles as $vehicle) : ?>
							<?php echo balanceTags(
								\MHMRentiva\Admin\Frontend\Shortcodes\SearchResults::render_vehicle_card($vehicle, $atts['layout'] ?? 'grid'),
								true
							); ?>
						<?php endforeach; ?>
					<?php else : ?>
